    ...
    <div class="schedule__body timetable">
        ...
        <div class="timetable__top">
            <div class="timetable__arrow prev">
                <img src="<?php echo plugin_dir_url( SCHEDULE_ROOT . '/schedule.php' ) ?>public/img/prev.svg" alt="">
            </div>
            ...
            <div class="timetable__arrow next">
                <img src="<?php echo plugin_dir_url( SCHEDULE_ROOT . '/schedule.php' ) ?>public/img/next.svg" alt="">
            </div>
        </div>
